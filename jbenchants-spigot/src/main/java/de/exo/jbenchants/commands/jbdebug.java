                ...
                case 1:
                    switch (args[0]) {
                        ...
                        case "nbte":
                            ...
                            break;
                        case "nbtb":
                            NBTBlock nbtb = new NBTBlock(player.getTargetBlock( null, 10));
                        ...
                        case "enchants":
                            ...
                            break;
                        case "lock":
                            if (nbt.checkLockedBlock(player.getTargetBlock(null, 10))) {
                                nbt.lockBlock(player.getTargetBlock(null, 10), false);
                                player.sendMessage("§aBlock has been unlocked.");
                            } else {
                                nbt.lockBlock(player.getTargetBlock(null, 10), true);
